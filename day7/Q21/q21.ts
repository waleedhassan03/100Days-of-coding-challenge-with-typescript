...
let objects: { CompanyName: string; Cartype: string; Owner: string; year: number } = {
...
console.log(`company name: ${objects.CompanyName}, type of car: ${objects.Cartype}, made by ${objects.Owner}, and completed in year: ${objects.year}`);